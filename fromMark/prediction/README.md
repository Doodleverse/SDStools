...
$$Y_{i+1} = [y_{i+1, 1}, y_{i+1, 2}, ..., y_{i_1, n}] = f([y_{i, 1}, y_{i-1, 1}, ..., y_{i-k, 1}], 
...
random walk, rendering the rest of this exercise as useless. This might be due to the quality of your data, or, the process you are studying, according to the way you measure it, is unpredictable.
